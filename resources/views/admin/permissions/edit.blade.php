    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid" id='createhotel'>
                <h6 class="text-center display-4">تعديل صلاحية   </h6>

                <form method="POST" enctype="multipart/form-data"  id='updatepermission'>
                    @csrf
                    <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text"   name='name'  class="form-control form-control-lg" value="{{$permission->name}}"  >
