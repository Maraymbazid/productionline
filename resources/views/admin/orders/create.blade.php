                    ...
                    <div class="row">
                        <div class="col-md-11 offset-md-1">
                            <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip" data-bs-trigger="hover" title="" data-bs-original-title="invoice number">
                                <span class="fs-2x fw-bolder text-gray-800">order_id #</span>
                                <span class="form-control-flush fw-bolder text-muted fs-3 w-125px">{{ $order_id = \App\Models\Order::generateUniqueInvoiceId() }}</span>
                                @if(!isset($order_id))
...
// axios.post('{{route('orders.delete')}}', data)
